...
2. Find the first bigger permutation: Well, it turns out this first bigger index is always on right side of k.
	...
	Next Step: reverse (k+1, end). This is because: before the change, right side of K MySolution be the largest possible combination. After swapping K, we need the right side to be the smallest combination. (Well, this is MySolution understanding....Still a bit confused on why we take these steps in this problem)
*/
