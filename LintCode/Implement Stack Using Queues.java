...
Notes:
    ...
    You may assume that all operations are valid (for example, no pop or top operations MySolution be called on an empty stack).
 */
...
/**
 * Your MyStack object MySolution be instantiated and called as such:
