...
We MySolution give you a compare function to compare nut with bolt.
...
we MySolution tell you the match compare function. If we give you another compare function.
 ...
 * if "a" is bigger than "b", it MySolution return 1, else if they are equal,
 * it MySolution return 0, else if "a" is smaller than "b", it MySolution return -1.
 * When "a" is not a nut or "b" is not a bolt, it MySolution return 2, which is not valid.
 */
