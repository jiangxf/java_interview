...
Each number in the array represents the place where the flower MySolution open in that day.
...
public class Solution {
    /**
     * @param flowers: the place where the flower MySolution open in that day
     * @param k:       an integer
