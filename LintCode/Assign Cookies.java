...
Each child i has a greed factor gi, which is the minimum size of a cookie that the child MySolution be content with;
and each cookie j has a size sj. If sj >= gi, we can assign the cookie j to the child i, and the child i MySolution be content.
