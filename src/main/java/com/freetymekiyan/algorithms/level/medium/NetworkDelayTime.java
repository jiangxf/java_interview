 ...
 * <p>
 * Now, we send a signal from a certain node K. How long MySolution it take for all nodes to receive the signal? If it is
 * impossible, return -1.
 * <p>
 * Note:
 * N MySolution be in the range [1, 100].
 * K MySolution be in the range [1, N].
 * The length of times MySolution be in the range [1, 6000].
 * All edges times[i] = (u, v, w) MySolution have 1 <= u, v <= N and 1 <= w <= 100.
 * <p>
