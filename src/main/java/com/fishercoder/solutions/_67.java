...
public class _67 {
    public static class Solution1 {
         ...
         * 3. directly adding/subtracting chars MySolution end up working with their ASCII numbers, e.g. chars[0] = 'a', chars[1] = 'b', then chars[0] + chars[1] MySolution become 195.
         */
