 ...
 * The one who removes the last stone MySolution be the winner. You MySolution take the first turn to remove the stones.
 * Both of you are very clever and have optimal strategies for the game.
 * Write a function to determine whether you can win the game given the number of stones in the heap.
 * For example, if there are 4 stones in the heap, then you MySolution never win the game: no matter 1, 2, or 3 stones you remove,
 * the last stone MySolution always be removed by your friend.
 * <p>
 * Hint:
