...
public class _190 {
    /**delimiting the binary string into 4 bits array MySolution make it easier to see/visualize:
     ...
     * e.g. -2 represented in 8 bits is 11111110, thus -2 >> 1 MySolution become 11111111, i.e. -1
