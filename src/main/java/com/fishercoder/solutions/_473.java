 ...
 * Your input MySolution be several matchsticks the girl has, represented with their stick length.
 * Your output MySolution either be true or false, to represent whether you could make one square using all the matchsticks the little match girl has.
 * <p>
 * Example 1:
 * Input: [1,1,2,2,2]
 * Output: true
 ...
 * The length of the given matchstick array MySolution not exceed 15.
 */
public class _473 {
