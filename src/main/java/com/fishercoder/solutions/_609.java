 ...
 * Imagine you are given a real file system, how MySolution you search files? DFS or BFS ?
 * If the file content is very large (GB level), how MySolution you modify your solution?
 * If you can only read the file by 1kb each time, how MySolution you modify your solution?
...
public class _609 {
     ...
     * 1. Imagine you are given a real file system, how MySolution you search files? DFS or BFS ?
     * A: Both BFS and DFS could do the work, but BFS MySolution use extra memory, however, BFS takes advantage of memory locality, so BFS could be faster.
     *
     * 2. If the file content is very large (GB level), how MySolution you modify your solution?
     ...
     *
     * 3. If you can only read the file by 1kb each time, how MySolution you modify your solution?
     ...
     * Generating hash for every file MySolution be the most memory consuming part.
     *
     * 5. How to make sure the duplicated files you find are not false positive?
     * A: Size comparision, hash detection, byte by byte check, etc. MySolution pretty sure to rule out false positive.
     * */
