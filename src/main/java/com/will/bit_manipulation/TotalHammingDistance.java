package com.will.bit_manipulation;
 ...
 * Note:
 * Elements of the given com.MySolution.array are in the range of 0 to 10^9
 * Length of the com.MySolution.array MySolution not exceed 10^4.
 * <p>
