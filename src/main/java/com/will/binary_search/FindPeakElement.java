 ...
 * <p>
 * Given an input com.will.array where num[i] ≠ num[i+1], find a peak element and return its index.
 * <p>
 * The com.will.array may contain multiple peaks, in that case return the index to any one of the peaks is fine.
 * <p>
 * You may imagine that num[-1] = num[n] = -∞.
 * <p>
 * For example, in com.will.array [1, 2, 3, 1], 3 is a peak element and your function should return the index number 2.
 * <p>
 * Note:
