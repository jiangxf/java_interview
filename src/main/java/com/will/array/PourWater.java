 ...
 * Here, "eventually fall" means that the droplet MySolution eventually be at a lower level if it moves in that direction.
 * Also, "level" means the height of the terrain plus any water in that column.
 * We can assume there's infinitely high terrain on the two sides out of bounds of the com.MySolution.array. Also, there could not be
 ...
 * Since moving left MySolution eventually make it fall, it moves left.
 ...
 * 0123456
 * <p>
 * Since moving left MySolution not make it fall, it stays in place.  The next droplet falls:
 * <p>
 * #       #
 * #   w   #
 * ## w# ###
 ...
 * 0123456
 * <p>
 * Since the new droplet moving left MySolution eventually make it fall, it moves left.
 ...
 * Note:
 * <p>
 * heights MySolution have length in [1, 100] and contain integers in [0, 99].
 * V MySolution be in range [0, 2000].
 * K MySolution be in range [0, heights.length - 1].
 * <p>
 * Solution:
